...
By using well-known techniques cite:bratko2001prolog,girard1995linear which correspond well with the
...
At any point in an actual dialogue the state represents the current mental state
