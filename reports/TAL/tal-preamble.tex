...
\resume{
Cet article propose une formalisation de la gestion de
dialogue via la recherce de preuve de formule en logique linéaire.
%
Nous proposons que la logic linéaire constitue une base naturelle la
formalisation de systèmes de gestion de dialogue basé sur un état
d'information.  Nous prêtons une attention particulière à la
modelisation des séquences de questions-reponses (y compris les
demandes de clarification), et nous arguons que les metavariables,
résultant des unifications issue de la recherche de preuves, jouent un
rôle décisif dans la formalisation.
%
...
recherche de preuve générique, ainsi que d'un expample de gestion de
