...
\journal{TAL. Volume VOL -- n°X/YYYY}{1}{25}
% VOL: TAL volume; X:  TAL number in the volume; YYYY: year; 
% F: first page number of the paper; L: last page number

\author{Vladislav$_1$ Maraev$_1$\fup{*}\andauthor Jean-Philippe$_2$ Bernardy$_2$\fup{*}  \andauthor Jonathan$_3$ Ginzburg$_3$\fup{**}} 
