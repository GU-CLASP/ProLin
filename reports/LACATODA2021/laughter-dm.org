...
some of the ICM moves, and, with some possible caveats, we can
sometimes include a slight laughter in such moves. Considering the
evidence for laughter often accompanying apology (as a separate
dialogue act) presented in Section ref:sec:apology, this can mimic a
natural behaviour in dialogue.
