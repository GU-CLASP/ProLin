...
# JP the demo? This is coming unexepected. What is this demo?
...
# JP: Perhaps delete this bit about CRs?
...
strategies, replicating the account of citet:larsson2002issue for grounding
...
a boolean, and depending on the answer the context will contain
...
score where the system produces |ICM Und Pos q| move, but this is out of
...
"flashcard" app, the system provides users with a word in one language on
the front side of the card and the user should provide a translation. Then
the user gets the correct response from the back side of the card and then
evaluates her own response (Hard, Good or Easy).
# JP level of difficulty of the question? I don't get it.
 If we consider making
