...
accounted for, at least rudimentarily, within a proposed framework.
...
On this level what has being understood can be either accepted or rejected for the current purpose. Acceptance laughter can be typically related to reaction to humour, which is out of scope of the current study, or apology (see next section). 

Citet:ginzburg2020laughter consider some uses of standalone laughter as cases of negative response to a polar question or a signal of disbelief in previously uttered assertion. In this study we reflect on negative responses like ref:ex:neuer.
#+BEGIN_lingex
...
with other dialogue acts. On the Figure ref:fig:orbit we show how many
...
depending on the speaker. In addition to apology, we show it's
...
In ref:ex:apology  caller reacts with a compassionate laughter to
the apology given by the operator. This similar instances of laughter
