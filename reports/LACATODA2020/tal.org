...
**** Alternative representation with binary predicates only (DB normalisation)

Question: |\x. if x then (Live John y ∧ Name y Paris) else Not (Live John y) ∧ Name y Paris|
...
Clarification question: |Q Country z (z=y)|

or even better: |Q Bool (\x. if x then Country France y else Not (Country France y))|
