...
#+LATEX_HEADER: \newcommand\citet[1]{\citeasnoun{#1}}
...
[[cite:roberts2012information][e.g.::]], which represent a single
context for both dialogue participants), KoS keeps a separate
...
Treatment of "no" [fn::TBD move this to the table and explain!]:
#+BEGIN_code
