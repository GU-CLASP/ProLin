...
2) An *Assertion* is a proposition |R : Prop|, represented as |Assert R|
...
[a : Type;
 ...
 proof :: p] ?-> CR
#+END_code
(We leave unspecified the exact form of the CR abstract for now and
come back to it below in section ref:sec:dm)
