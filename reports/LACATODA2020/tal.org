...
The clarifying side sequence itself (|CR|) is supposed to be specified
by a dialogue developer, because it is domain-specifica and the choice
of the possible options is wide. We will provide an example of
