...
TODO: This paragraph feels out of place here this should go to related work (purver section.)
...
Does John live in Paris? & |Prop -> Prop| & |\m. m (Live John Paris)                 | & from January & \makecell[l]{|ShortAnswer (Prop -> Prop)|\\|(\x. FromJanuary(x))|} \\\hline
...
*** Clarification via adding extra arguments :TODORemovalCandidate:
