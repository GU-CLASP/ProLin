...
#+BEGIN_code
HasTurn USER
Moves [ CounterGreet SYSTEM USER   
        Greet USER SYSTEM         ]
#+END_code
...
HasTurn SYSTEM
Moves [  Ask (Question USER Time t0 (TT n0 t0 Gotaplatsen d0)) USER SYSTEM
         CounterGreet SYSTEM USER
         Greet USER SYSTEM  ]
#+END_code

Now, dependent on the state of the knowledge base, the system will
...
#+BEGIN_code
Answered (Question USER Time T15 (TT B18 T15 Gotaplatsen Johanneberg))
QUD Nil
HasTurn SYSTEM
