...
Consider now the closed question "Does John live in Paris?".
But where the system has a 3-place predicate for live, where the country is specified; and we have:
...
formulation of the question. In this case "Do you mean Paris, France?"
would be suitable.
...
Use the same basic idea as citet:dixon2009plans. But we have the additional unicity
...
This moves can be received either by the NLU component, in which case
