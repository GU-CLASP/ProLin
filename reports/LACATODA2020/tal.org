...
In the view of citet:cite:dixon2009plans, this is best done by
...
intuition of information-state management, we are able to provide a
fully working prototype of the components of our framework:
...
2. a set of rules which function as a core framework for dialogue
   management (in the style of KoS)
...
does in the weekend -> General OnWeekend ):
