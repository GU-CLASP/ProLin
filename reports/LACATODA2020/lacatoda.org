...
With this, we are ready to state understand the keystone of our theory:
...
Then "What do you eat?" is a felicitous question
...
Then "What do you eat?" is not a felicitous question.


Anything which can be subject to clarification should be represented
(or mediated) by a metavariable.
